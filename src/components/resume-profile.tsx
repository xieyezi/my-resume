    ...
    <header className='resume-header md:flex md:items-center md:justify-between md:flex-row-reverse mb-4'>
      <div className='flex justify-center md:justify-end md:flex-1'>
        <a href='https://www.xieyezi.info/' target='_self' className='relative w-28 h-28 rounded-full overflow-hidden block'>
          <Image
            src='https://test.fukit.cn/autoupload/f/UMEYPF7R5wisQia7aduOCNiO_OyvX7mIgxFBfDMDErs/20260413/Ws4R/1706X1279/avatar2.jpg/webp'
            alt='Profile'
            fill
      ...
      <div className='header-info md:text-left text-center mt-2 md:mt-0'>
        ...
        <ul className='link-list text-left flex md:items-center flex-wrap'>
          ...
          <li className='mr-3 mb-2 flex items-center'>
            ...
            <a
              href='https://picui.ogmua.cn/s1/2026/03/28/69c7736b8dd8e.webp'
              target='_blank'
          ...
          <li className='mr-3 mb-2 flex items-center'>
            ...
            <a href='tel:17783887443' className='text-gray-600 dark:text-gray-300 hover:text-gray-800'>
              {t("phone")}
            </a>
          </li>
        </ul>
